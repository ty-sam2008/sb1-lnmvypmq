    ...
    <div className="min-h-screen bg-white pt-16">
      ...
      <header className="relative min-h-[600px] flex items-center bg-orange-950">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <picture>
            <source
              srcSet="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=2000"
              media="(min-width: 1024px)"
            />
            <source
              srcSet="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=1200"
              media="(min-width: 768px)"
            />
            <img 
              src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=800"
              alt="Women Railway Workers in Safety Gear"
            ...
            <div className="bg-orange-800/30 p-8 rounded-2xl backdrop-blur-sm border border-orange-700/30">
              <div className="aspect-video rounded-xl overflow-hidden shadow-2xl">
                <div className="w-full h-full bg-orange-900/50 flex items-center justify-center">
                  <p className="text-orange-200">Video testimonial will be placed here</p>
                </div>
              </div>
